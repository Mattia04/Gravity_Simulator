...
body4 : Body = Body("Terra",   const.EARTH_M,   *create_position(const.EARTH_D,   const.EARTH_V,    1.5,    get_perpendicular(1.5)))
body5 : Body = Body("Marte",   const.MARS_M,    *create_position(const.MARS_D,    const.MARS_V,     4.4,    get_perpendicular(4.4)))
body6 : Body = Body("Giove",   const.JUPITER_M, *create_position(const.JUPITER_D, const.JUPITER_V,  0.7,    get_perpendicular(0.7)))
body7 : Body = Body("Saturno", const.SATURN_M,  *create_position(const.SATURN_D,  const.SATURN_V,   6,      get_perpendicular(6)))
