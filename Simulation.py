...
def test_accuracy(*Bodies : Tuple[Body], interval : int = 100, iters : int = 1000) -> None:
    ...
    # TODO personalize the bar to show elapsed_time, eta, bar and %, it/s, %of energy error
    # TODO create a function to calculate the % energy error
    # TODO      for the current iteration and for the total error
